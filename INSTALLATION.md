...
[![Tests](https://img.shields.io/badge/Tests-491%20Passing-brightgreen?style=for-the-badge&logo=checkmarx&logoColor=white)](hooks/test.js)
...
Verify all 491 test fixtures, pattern compilations, secret masking, and MCP tool handlers:
