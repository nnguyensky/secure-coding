...
[![Tests](https://img.shields.io/badge/Tests-460%20Passing%20(100%25)-brightgreen?style=for-the-badge&logo=checkmarx&logoColor=white)](hooks/test.js)
...
13 language templates · 376 patterns mapped to CWE and OWASP Top 10:2025 · 460
...
```bash
node hooks/test.js     # expect: pass=460 fail=0
...
| | `node hooks/clean.js --all` | Lints every tracked file (`npm run clean`). |
...
| | `node hooks/test.js` | Executes the full 460-test self-check suite. |
