...
[![Tests](https://img.shields.io/badge/Tests-484%20Passing%20(100%25)-brightgreen?style=for-the-badge&logo=checkmarx&logoColor=white)](hooks/test.js)
...
13 language templates · 376 patterns mapped to CWE and OWASP Top 10:2025 · 484
...
```bash
node hooks/test.js     # expect: pass=484 fail=0
...
| | `node hooks/test.js` | Executes the full 484-test self-check suite. |
...
Verify all 484 test assertions, pattern compilation, secret masking, and MCP tools:
