...
[![Tests](https://img.shields.io/badge/Tests-465%20Passing%20(100%25)-brightgreen?style=for-the-badge&logo=checkmarx&logoColor=white)](hooks/test.js)
...
13 language templates · 376 patterns mapped to CWE and OWASP Top 10:2025 · 465
...
```bash
node hooks/test.js     # expect: pass=465 fail=0
...
| | `node hooks/test.js` | Executes the full 465-test self-check suite. |
